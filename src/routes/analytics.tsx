          ...
          <div className="mt-3 h-64">
            <ResponsiveContainer>
              <BarChart data={byConfidence} barSize={40}>
                <XAxis dataKey="name" stroke="#8A99A8" fontSize={12} tickLine={false} axisLine={false} />
                <YAxis stroke="#8A99A8" fontSize={12} allowDecimals={false} tickLine={false} axisLine={false} />
                <Tooltip
            ...
            {summary && (
              <div className="mt-4 grid grid-cols-3 gap-3">
                {[
                  ...
                  { label: "Taxa de acerto", value: `${(summary.accuracy * 100).toFixed(1)}%`, icon: "🎯" },
