        ...
        <section className="rounded-lg border border-border bg-card p-4 sm:p-5">
          ...
          <div className="mt-3 grid gap-4 sm:grid-cols-2">
            {data.recent.length > 0 && (
              <div>
                <p className="mb-2 text-[11px] font-semibold text-muted-foreground/50">Recentes</p>
            ...
            {data.upcoming.length > 0 && (
              <div>
                <p className="mb-2 text-[11px] font-semibold text-muted-foreground/50">Próximos</p>
                <ul className="space-y-1.5">
        ...
        <section className="rounded-lg border border-border bg-card p-4 sm:p-5">
          ...
          <ul className="mt-3 space-y-1.5">
            {data.squad.map((p, i) => (
              <li
                key={`${p.name}-${i}`}
                className="flex items-center gap-2 rounded border border-border/30 bg-white/[0.02] px-3 py-2 text-xs"
              >
                {p.number && (
